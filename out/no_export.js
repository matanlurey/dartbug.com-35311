...
(function dartProgram() {
  ...
  M = {
    main: function() {
      ...
      if (H.stringContainsUnchecked(t1, "doLoad", 0))
        new M.main_closure().call$0().then$1$1(new M.main_closure0(), type$.MyComponent);
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return P._asyncAwait(H.loadDeferredLibrary("b"), $async$call$0);
            case 3:
              // returning from await.
              H.checkDeferredIsLoaded("b");
  ...
  var init = {
    ...
    deferredLibraryParts: {b: [0]},
    deferredPartUris: ["no_export.js_1.part.js"],
    deferredPartHashes: ["BbQ0C/JVo0cyMdoVSJo/jzeO0rQ="],
...
//# sourceMappingURL=no_export.js.map
