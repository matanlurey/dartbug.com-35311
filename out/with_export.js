...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
    ...
    diagnoseIndexError: function(indexable, index) {
      ...
      $length = H._asIntNullable(J.get$length$as(indexable));
    ...
    checkDeferredIsLoaded: function(loadId) {
      if (!$.$get$_loadedLibraries().contains$1(0, loadId))
        throw H.wrapException(new H.DeferredNotLoadedError(loadId));
    },
    ...
    loadDeferredLibrary: function(loadId) {
      ...
      if (indexes == null) {
        t1 = new P._Future($.Zone__current, type$._Future_Null);
    ...
    _computeThisScript: function() {
      ...
      if (H.boolConversionCheck(!self.window && !!self.postMessage))
    ...
    _loadHunk: function(hunkName) {
      var deferredLibraryLoader, failure, jsSuccess, jsFailure, error, stackTrace, uri, t2, completer, t3, exception, index, xhr, script, t1 = {},
        future = $._loadingLibraries.$index(0, hunkName);
      C.JSArray_methods.add$1($._eventLog, " - _loadHunk: " + hunkName);
      if (future != null) {
        C.JSArray_methods.add$1($._eventLog, "reuse: " + hunkName);
        return future.then$1$1(new H._loadHunk_closure(), type$.Null);
      }
      uri = t1.uri = $.$get$thisScript();
      uri = C.JSString_methods.substring$2(uri, 0, J.lastIndexOf$1$s(uri, "/") + 1) + hunkName;
      t1.uri = uri;
      C.JSArray_methods.add$1($._eventLog, " - download: " + hunkName + " from " + uri);
      deferredLibraryLoader = self.dartDeferredLibraryLoader;
      t2 = new P._Future($.Zone__current, type$._Future_Null);
      completer = new P._AsyncCompleter(t2, type$._AsyncCompleter_Null);
      ...
      else if (H.boolConversionCheck(!self.window && !!self.postMessage)) {
      ...
      $._loadingLibraries.$indexSet(0, hunkName, t2);
      return t2;
    },
  ...
  P = {
    ...
    Future_wait: function(futures, $T) {
      var handleError, future, pos, e, st, t2, t3, _i, t4, exception, error, stackTrace, _box_0 = {}, cleanUp = null,
        eagerError = false,
      ...
      try {
        ...
        _box_0.values = H.setRuntimeTypeInfo(t2, $T._eval$1("JSArray<0>"));
      } catch (exception) {
    ...
    IndexError$: function(invalidValue, indexable, $name, message, $length) {
      var t1 = H._asIntNullable($length == null ? J.get$length$as(indexable) : $length);
  ...
  X = {
    main: function() {
      ...
      t1.toString;
      if (H.stringContainsUnchecked(t1, "doLoad", 0))
        new X.main_closure().call$0().then$1$1(new X.main_closure0(), type$.MyComponent);
    },
  ...
  H.loadDeferredLibrary_initializeSomeLoadedHunks.prototype = {
    call$0: function() {
      ...
      for (t1 = _this._box_0, i = t1.nextHunkToInitialize, t2 = _this.total, t3 = _this.initializer, t4 = _this.isHunkLoaded, t5 = _this.isHunkInitialized, t6 = _this.uris, t7 = _this.hashes, t8 = _this.waitingForLoad, t9 = t8.length; i < t2; ++i) {
        ...
        hash = t7[i];
        if (t5(hash)) {
          C.JSArray_methods.add$1($._eventLog, " - already initialized: " + uri + " (" + hash + ")");
          continue;
        }
        if (t4(hash)) {
          C.JSArray_methods.add$1($._eventLog, " - initialize: " + uri + " (" + hash + ")");
          t3(hash);
        } else {
          C.JSArray_methods.add$1($._eventLog, " - missing hunk: " + uri + " (" + hash + ")");
          if (i >= t6.length)
            return H.ioore(t6, i);
          throw H.wrapException(P.DeferredLoadException$("Loading " + t6[i] + " failed: the code with hash '" + hash + "' was not loaded.\nevent log:\n" + C.JSArray_methods.join$1($._eventLog, "\n") + "\n"));
        }
      }
    },
    $signature: 1
  ...
  H.loadDeferredLibrary_loadAndInitialize.prototype = {
    call$1: function(i) {
      ...
      if (_this.isHunkLoaded(t1[i])) {
        C.JSArray_methods.$indexSet(_this.waitingForLoad, i, false);
      ...
      if (i >= t1.length)
        return H.ioore(t1, i);
      return H._loadHunk(t1[i]).then$1$1(new H.loadDeferredLibrary_loadAndInitialize_closure(_this.waitingForLoad, i, _this.initializeSomeLoadedHunks), type$.dynamic);
    },
    $signature: 6
  };
  ...
  H._loadHunk_success.prototype = {
    call$0: function() {
      C.JSArray_methods.add$1($._eventLog, " - download success: " + this.hunkName);
  ...
  H._loadHunk_failure.prototype = {
    call$3: function(error, context, stackTrace) {
      ...
      t1 = this.hunkName;
      C.JSArray_methods.add$1($._eventLog, " - download failed: " + t1 + " (context: " + context + ")");
      $._loadingLibraries.$indexSet(0, t1, null);
      if (stackTrace == null)
  ...
  X.main_closure.prototype = {
    call$0: function() {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.MyComponentFactory),
        $async$returnValue;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return P._asyncAwait(H.loadDeferredLibrary("a"), $async$call$0);
            case 3:
              // returning from await.
              H.checkDeferredIsLoaded("a");
              $async$returnValue = Q.createMyComponentFactory();
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  X.main_closure0.prototype = {
    call$1: function(c) {
      return type$.MyComponentFactory._as(c).createComponent$0();
    },
  ...
  (function inheritance() {
    ...
    _inherit(W.Window, W.EventTarget);
  ...
  var init = {
    ...
    deferredLibraryParts: {a: [0]},
    deferredPartUris: ["with_export.js_1.part.js"],
    deferredPartHashes: ["Qjpo8cGHbSn6wIqK/IQ5aOg0Dzk="],
    typeUniverse: {eC: new Map(), tR: {}, eT: {}, tPV: {}, sEA: []},
    mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"},
    mangledNames: {},
    getTypeFromName: getGlobalFromName,
    metadata: [],
    types: ["Null()", "~()", "Null(@)", "~(~())", "@(@)", "Null(Object)", "Future<@>(int)", "Null(List<@>)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "Null(int,@)", "Null(Object,StackTrace)", "Null(@[StackTrace])", "_Future<@>(@)", "Null(@,@)", "@(Event)", "Future<MyComponentFactory>()", "MyComponent(MyComponentFactory)", "Null(MessageEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSDouble":{"num":[]},"JSString":{"String":[],"Pattern":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"DeferredNotLoadedError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"Zone":[]},"_LinkedHashSet":{"_SetBase":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"]},"_SetBase":{"Iterable":["1"]},"double":{"num":[]},"AssertionError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"int":{"num":[]},"List":{"Iterable":["1"]},"_StringStackTrace":{"StackTrace":[]},"String":{"Pattern":[]},"MessageEvent":{"Event":[]},"Window":{"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      MyComponent: findType("MyComponent"),
      MyComponentFactory: findType("MyComponentFactory"),
      Null: findType("Null"),
...
;
    ...
    C.List_empty = H.setRuntimeTypeInfo(makeConstList([]), H.findType("JSArray<Null>"));
  })();
  (function staticFields() {
    $.Closure_functionCounter = 0;
    $.BoundClosure_selfFieldNameCache = null;
    $.BoundClosure_receiverFieldNameCache = null;
    $._loadingLibraries = P.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.Future_Null);
...
//# sourceMappingURL=with_export.js.map
